...
class PartNavButtonsConfig extends StatelessWidget {
  const PartNavButtonsConfig({super.key});
...
class PartNavButtonsFinal extends StatelessWidget {
  const PartNavButtonsFinal({super.key});
